...
async function seedDatabase() {
  try {
    ...
    const combosCategory = await db.menuCategory.create({
      data: {
        name: "Combos",
    ...
    const hamburguersCategory = await db.menuCategory.create({
      data: {
        name: "Lanches",
        restaurantId: restaurant.id,
      },
    ...
    const frenchFriesCategory = await db.menuCategory.create({
      data: {
        name: "Fritas",
        restaurantId: restaurant.id,
      },
    ...
    const drinksCategory = await db.menuCategory.create({
      data: {
        name: "Bebidas",
        restaurantId: restaurant.id,
      },
    ...
    const desertsCategory = await db.menuCategory.create({
      data: {
        name: "Sobremesas",
        restaurantId: restaurant.id,
      },
